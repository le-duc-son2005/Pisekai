        ...
        {!user ? (
          <>
            ...
            <div className="panel-content">
              {tab === "login" ? (
                // Do not auto-close panel after login; show account view
                <LoginForm />
              ) : (
          ...
          <div className="panel-content">
            ...
            <nav className="user-menu">
              <button className="menu-item" onClick={() => { navigate("/Profile"); onClose && onClose(); }}>Profile</button>
              <button className="menu-item" onClick={() => { navigate("/recharge"); onClose && onClose(); }}>Recharge</button>
              <button className="menu-item danger" onClick={() => { logout(); onClose && onClose(); }}>Logout</button>
            </nav>
          </div>
        )}
      </div>
